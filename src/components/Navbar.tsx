      ...
      <div className="container flex h-16 items-center justify-between px-4 sm:px-6">
        <div className="flex items-center gap-4">
          ...
          <nav className="hidden md:flex gap-4 ml-4">
            ...
            {isLoggedIn && <Link to="/create" className="font-medium hover:text-pin-red transition-colors">
                Create
              </Link>}
          </nav>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <Button variant="outline" size="sm" className="hidden sm:flex items-center" onClick={() => navigate('/search')}>
